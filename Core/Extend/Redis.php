...
class Redis
{
    ...
    private function __construct($index = 'token'){
        ...
        self::$redis->connect($conf[$index]['host'], $conf[$index]['port']);
        if (self::$redis->auth($conf[$index]['password']) == false) {
    ...
    */
    ...
    public function del( $key1, $key2 = null, $key3 = null ) {
        return self::$redis->del( $key1, $key2 = null, $key3 = null );
    }
}