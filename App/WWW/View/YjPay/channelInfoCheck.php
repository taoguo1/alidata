    ...
    <div class="ui-form ui-border-t">
        <form method='post' id="info" action="<?= $formUrl ?>">
            <div class="ui-form-item ui-border-b">
                <label>联系电话：</label>
                <input type="tel" name="phone" id="phone" pattern="[0-9]*" value="" onkeyup="setNumWord(this,11)"/>
            </div>
            <div class="ui-form-item ui-border-b">
                <label>信用卡号：</label>
                <input type="number" name="creditCardNo" pattern="[0-9]*" id="creditCardNo" value=""/>
            </div>
            <div class="ui-form-item ui-border-b">
                <label>真实名称：</label>
            ...
            <div class="ui-form-item ui-border-b">
                <label>银行预留电话:</label>
                <input type="tel" name="bankPhone" pattern="[0-9]*"  id="bankPhone" value="" onkeyup="setNumWord(this,11)"/>
            </div>
            <div class="ui-form-item ui-border-b">
                <label>身份证正面照：</label>
            ...
            <div class="ui-form-item ui-border-b">
                <label>身份证背面照：</label>
                <input type="file" name="idBack" id="idBack"/>
            </div>
    ...
    $(function () {
        ...
        submitBtn.on('click', function () {
           ...
           var  phone = $.trim($("#phone").val()),
            ...
            idFront  = $.trim($("#idFront").val()),
            idBack  = $.trim($("#idBack").val());


            if(!(checkPhone(phone) && checkCredit(creditCardNo) && checkName(realName) && checkCard(identityNo) && checkBankPhone(bankPhone) && checkFront(idFront) && checkBack(idBack))){
                return false;
            }

            uploadStatus = uploadImg("<?=$uploadImgUrl?>", ['idFront', 'idBack']);
