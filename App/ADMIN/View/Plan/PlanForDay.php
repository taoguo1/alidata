...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('Plan','PlanForDay')?>" method="post">
		<div class="searchBar">
	...
	<table class="list" width="100%" layoutH="90">
		<thead>
			<tr>
				...
				<!-- <th width="60" align="center" orderField="errorStatus" class="<?=($data['orderField']=='errorStatus')?$data['orderDirection']:'';?>">是否正常</th> -->
		...
		<?php foreach ($data['list'] as $k=>$v){?>
			<tr target="id" rel="<?=$v['id']?>">
				...
				<!-- <td align="center"<?php if($v['errorStatus'] == '异常'){ ?> style="color:red;"<?php } ?>><?=$v['errorStatus']?></td> -->
