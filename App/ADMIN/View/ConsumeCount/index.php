...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('ConsumeCount','index')?>" method="post">
        <div class="searchBar">
        ...
        <table class="list" width="100%" layoutH="90">
            ...
            for($j = 1;$j <= \Core\Lib::getMonthLastDay($year,\Core\Lib::request('month'));$j++){
                ...
                <tr target="id" rel="<?=$j?>">
                    ...
                    <td align="center"><?=$data['day'][$j]['total']?></td>
                    <?php
                    for($i = 0;$i <= 23;$i++){
                        ?>
                        <td align="center">
